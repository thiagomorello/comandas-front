          ...
          <Tbody>
            <Tr>
              ...
              <Td borderColor={'gray.700'}>
                Lucas pegou 1 Vodka Absolut 1000ml Cartão 0001
              </Td>
              <Td isNumeric borderColor={'gray.700'} color={'red.300'}>
                R$ 80,00
              </Td>
            </Tr>
            <Tr>
              ...
              <Td borderColor={'gray.700'}>
                Lucas pegou 1 Suco Del Valle Uva Cartão 0001
              </Td>
              <Td isNumeric borderColor={'gray.700'} color={'red.300'}>
                R$ 12,00
              </Td>
            ...
            <Tr>
              ...
              <Td isNumeric borderColor={'gray.700'} color={'green.300'}>
                R$ 150,00
              </Td>
            </Tr>
            <Tr>
              ...
              <Td borderColor={'gray.700'}>
                Lorena pegou 1 Suco Del Valle Uva Cartão 0001
              </Td>
              <Td isNumeric borderColor={'gray.700'} color={'red.300'}>
                R$ 12,00
              </Td>
